...
public class Buffer {
   ...
   private long lastUnpinTimestamp; // per memorizzare il timestamp dell’unpin
    ...
    */
   public Buffer() {
	   setLastUnpinTimestamp(Calendar.getInstance().getTimeInMillis());
   }

   public void setLastUnpinTimestamp(long timeInMillis) {
	this.lastUnpinTimestamp=timeInMillis;	
   }
   
   public long getLastUnpinTimestamp() {
	return this.lastUnpinTimestamp;	
   }
